  ...
  function buildShell() {
    ...
    if (mainLayout) {
      ...
      pane.innerHTML =
        ...
        '<a class="crit-live-context-guide" id="liveUnavailableGuide" href="https://github.com/sho-hata/crit/blob/main/docs/live-mode.md" target="_blank" rel="noopener noreferrer">Troubleshooting guide</a>' +
        '</p>' +
        '</div>' +
