...
> If a plan was just written and the user said `/crit` or `crit`, invoke the `/crit` workflow — do not use this reference skill. This skill covers CLI operations like `crit comment` and `crit pull/push`.
