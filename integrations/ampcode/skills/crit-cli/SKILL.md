...
> If a plan was just written and the user said "crit" or "review", use the `crit` skill instead — it covers the full review loop. This skill covers CLI operations like `crit comment` and `crit pull/push`.
