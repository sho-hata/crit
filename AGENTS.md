...
- `GET  /api/lsp/hover?path=X&line=N&char=M` — language-server hover markdown for a position in a covered file (Go / TS / JS; line 1-based, char 0-based UTF-16)
